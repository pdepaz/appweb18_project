 ...
 * Generated at: 2018-11-29 10:38:02 UTC
...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("session_id") == null){ 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<li><button class=\"button\" onclick=\"document.getElementById('id01').style.display='block'\" style=\"width:auto;\">Iniciar Sesión</button></li>\n");
      out.write("\t\t\t\t\t\t\t");
 } else { 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<li><button class=\"button\" href=\"cerrar_sesion\">Cerrar Sesión</button></li>\n");
      out.write("\t\t\t\t\t\t\t");
 } 
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\t\t      <input type=\"text\" placeholder=\"Introduzca su email\" name=\"uname\" required>\n");
      out.write("\n");
      out.write("\t\t\t\t\t      <label for=\"psw\"><b>Contraseña</b></label>\n");
      out.write("\t\t\t\t\t      <input type=\"password\" placeholder=\"Introduzca su contraseña\" name=\"psw\" required>\n");
      out.write("\t\t\t\t\t        \n");
      out.write("\t\t\t\t\t      <button type=\"submit\" class=\"submitbutton\">Iniciar Sesión</button>\n");
      out.write("\t\t\t\t\t      <label>\n");
 ...
 if(session.getAttribute("session_id") == null){ 
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"#\" class=\"button primary\" onclick=\"document.getElementById('id01').style.display='block'\" style=\"width:auto;\">Iniciar Sesion</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"icon major fa-bolt accent2\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t<h3>Magna etiam</h3>\n");
      ...
      out.write("\t\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"icon major fa-area-chart accent3\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t<h3>Ipsum dolor</h3>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Integer volutpat ante et accumsan commophasellus sed aliquam feugiat lorem aliquet ut enim rutrum phasellus iaculis accumsan dolore magna aliquam veroeros.</p>\n");
      out.write("\t\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"features-row\">\n");
      out.write("\t\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"icon major fa-cloud accent4\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t<h3>Sed feugiat</h3>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Integer volutpat ante et accumsan commophasellus sed aliquam feugiat lorem aliquet ut enim rutrum phasellus iaculis accumsan dolore magna aliquam veroeros.</p>\n");
      out.write("\t\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"icon major fa-lock accent5\"></span>\n");
      out.write("\t\t\t\t\t\t\t\t<h3>Enim phasellus</h3>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Integer volutpat ante et accumsan commophasellus sed aliquam feugiat lorem aliquet ut enim rutrum phasellus iaculis accumsan dolore magna aliquam veroeros.</p>\n");
      out.write("\t\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</section>\n");
