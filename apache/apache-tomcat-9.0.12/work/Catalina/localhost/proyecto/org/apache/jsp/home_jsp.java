...
<<<<<<< HEAD
 * Generated at: 2018-12-13 18:47:58 UTC
=======
 * Generated at: 2018-12-13 16:50:06 UTC
...
if(session.getAttribute("session_id") == null){ 
 ...
 if(session.getAttribute("session_id") != null){ 
      out.write("\n");
      out.write("\t\t\t\t\t\t<h2>Busque información acerca de un usuario</h2>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"email\" name=\"email\" id=\"email\" placeholder=\"Email\" action=\"mandar_mail\">\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-4 col-12-mobilep\">\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"Enviar\" class=\"fit\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\n");
